...
function FieldGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/field-group gap-field-gap @container/field-group flex w-full flex-col data-[slot=checkbox-group]:gap-3 *:data-[slot=field-group]:gap-4',
        className,
      )}
      {...props}
    />
...
const fieldVariants = cva(
  'group/field flex w-full gap-control-gap data-[invalid=true]:text-destructive',
  {
    variants: {
      orientation: {
